...
@endphp
@section('title', 'Warhouses - ' . @$setting->title)
<x-app-layout>
    <!-- Page Content -->
    <main>
                                                                ...
                                                                <div class="col-md-12 col-sm-12 col-12 mt-3">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="name" placeholder="Warhouse Name *"
                                                                            onfocus="this.placeholder = ''"
                                                                            onblur="this.placeholder = 'Warhouse Name *'"
                                                                            value="{{ $item->name }}" />
                                                                    </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-12 mt-3">
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="name"
                                    placeholder="Warhouse Name *" onfocus="this.placeholder = ''"
                                    onblur="this.placeholder = 'Warhouse Name *'" />
                                @error('name')
