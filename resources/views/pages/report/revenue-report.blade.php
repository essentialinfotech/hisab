@section('title', 'Revenue Report - ' . @$setting->title)
<x-app-layout>
    <!-- Page Content -->
    <main>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="col-sm-12 col-md-12 col-12">
                                        <form action="{{ route('revenue-report') }}" method="post">
                                            @csrf
                                    ...
                                    <div id="print">
                                        <div class="col-sm-12 col-md-12 col-12">
                                            <div class="list-info">
                                                ...
                                                <p class="text-center m-0">Revinue</p>
                                            </div>
                                            <table id="example" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($allRevenue as $revenue)
                                                        <tr>
                                                            <td>{{ ++$sl }}</td>
                                                            <td>{{ \Carbon\Carbon::parse($revenue->date)->format('d/m/Y') }}
                                                                ({{ Carbon\Carbon::parse($revenue->date)->dayName }})
                                                            </td>
                                                        ...
                                                        @php
                                                            $trevenue += $revenue->amount;
                                                        @endphp
                                                    @endforeach
                                                </tbody>
                                                <tfoot>
                                                    <th colspan="4" class="text-right">Total Amount</th>
                                                    <th class="text-right">{{ number_format($trevenue, 2) }}</th>
                                                </tfoot>
                                            </table>
                                        </div>
                                    </div>
