...
@endphp
@section('title', 'Cost Category - ' . @$setting->title)
<x-app-layout>
    <!-- Page Content -->
    <main>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Cost Category</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                            ...
                                            @foreach ($cost_categories as $item)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        ...
                                                        <form action="{{ route('cost-categories.destroy', $item->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-danger btn-xs"
                                                                onclick="return confirm('Are you sure you want to delete this Cost Category ?');">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Edit Cost Category </h4>
                                                                <button type="button" class="close"
                                                                    data-dismiss="modal" aria-label="Close"><span
                                                                        aria-hidden="true">×</span></button>
                                                            </div>
                                                            <form
                                                                action="{{ route('cost-categories.update', $item->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('PUT')
        ...
        <div class="modal fade bs-example-modal-add_data" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Add Cost Category</h4>
